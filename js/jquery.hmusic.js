...
(function($, window){
    ...
    var HView = function(self)
    {
            ...
            control_loop:function()
            {
                switch(self.config.playMode)
                {
                    case 1:
                        ...
                        view.find('#arguments_type>span').text('Shuffle');
                        break;
                    case 2:
                        ...
                        view.find('#arguments_type>span').text('Single cycle');
                        break;
                    case 3:
                        ...
                        view.find('#arguments_type>span').text('List loop');
                        break;
                }
        ...
        var eventCallBack = {
            play:function()
            {
                ...
                // if(self.runtime.album.active != self.runtime.album.last)
                {
                    ...
                    view.find('#list-album .active>.status').html('Now Playing &gt; ');
                }
            ...
            ended:function(no)
            {
                ...
                // 去除歌词
                self.runtime.lrc = false;
                $('#HMusic-lrc').html('<ul><li class="base">HMusic Music Player</li></ul>');
        ...
        self.HMsg.listenMsg('updateview', function(musicInfo)
        {
            ...
            console.log( 'HMusic - Currently playing：' + musicInfo[dataFormat.music.name] + ' - ' + musicInfo[dataFormat.music.author] );
            // $.HmusicTips( '歌曲加载成功..' );
        });
    ...
    var HMusic = function( setting )
    {
        ...
        var content = [];
        content.push('<div class="an-panel"><div class="parameter"><div class="parameter-other"><div id="arguments_name" class="left"><i class="fa fa-music"></i><span class="arguments-name">Load...</span></div><div class="right"><i class="fa fa-clock-o"></i><span class="arguments-time">00:00</span> /<span class="arguments-total">00:00</span></div></div><div class="parameter-other"><div id="arguments_author" class="left"><i class="fa fa-user"></i><span class="arguments-author">Load...</span></div><div class="right" id="arguments_type"><i class="fa fa-exchange"></i><span class="arguments-type">List loop</span></div></div><div class="parameter-other"><div id="arguments_special" class="left"><i class="fa fa-folder"></i><span class="arguments-special">Load...</span></div><div class="right"><i class="fa fa-check-circle"></i><span class="arguments-lrc">Lyrics on</span></div></div></div><div id="cover" class="cover"><img src="image/avatar.jpg"></div><div class="control"><i id="control_loop" class="control-loop fa fa-exchange" title="List loop"></i><i id="control_prev" class="control-prev fa fa-backward" title="Previous song"></i><div id="control_status" class="control-status"><i class="control-play fa fa-play" title="Play"></i><i class="control-pause fa fa-pause" title="Time Out"></i></div><i id="control_next" class="control-next fa fa-forward" title="Next song"></i><i id="control_heart" class="control-heart fa fa-heart" title="Favorites "></i></div><div id="ProgressBar" class="progress-bar"><div class="bar"><div class="active"></div></div></div><div class="bottom"><div class="bottom-left"><i class="btn-trumpet fa fa-volume-up"></i><div id="VolumeBar" class="volume-bar"><div class="progress-bg"><div class="volume-on ts5"><div class="drag" title="Volume"></div></div></div></div></div><div class="bottom-right"><div class="btn-list"><i class="fa fa-bars" id="FunBtnList" title="Playlist"></i></div><div class="btn-list"><i class="fa fa-toggle-on active" id="FunBtnLrc" title="Lyrics switch "></i></div></div></div></div><div class="an-list"><div id="list-album" class="list-block list-album active"><div class="block-title"><span class="title">Album List</span>                (<span class="number">0</span>)</div><div class="block-content"></div></div><div id="list-music" class="list-block list-music"><div class="block-title"><i class="fa fa-angle-left"></i><span>Ziiber List of songs</span></div><div class="block-content"></div></div></div><div class="an-side" id="btn_side"><i class="fa fa-angle-right"></i></div><div class="flat"><i class="fa fa-music"></i><i class="fa fa-music"></i><i class="fa fa-music"></i><i class="fa fa-music"></i><i class="fa fa-music"></i><i class="fa fa-music"></i></div>');
